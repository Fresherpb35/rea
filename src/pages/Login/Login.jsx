...
import { Mail, Lock, Smartphone, UserCircle } from 'lucide-react';
...
const Login = () => {
 ...
 const handleGoogleSignIn = async () => {
  ...
  disabled={isLoading}
  className="w-full bg-white text-gray-700 hover:bg-gray-50 border-2 border-gray-300 py-3 sm:py-4 px-6 rounded-full font-semibold text-base sm:text-lg transition-colors flex items-center justify-center gap-2 disabled:cursor-not-allowed"
>
  {isLoading ? (
